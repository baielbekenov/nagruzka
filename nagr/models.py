...
class Groupp(models.Model):
    ...
    amount_of_credit = models.IntegerField(default=5)
...
class Discipline(models.Model):
    ...
    group_id = models.ManyToManyField(Groupp, related_name='group')
    teacher = models.ForeignKey('Teacher', on_delete=models.CASCADE, related_name='disciplene')
